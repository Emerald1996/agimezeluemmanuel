...
import countries from '../assets/country-data-project.png'
...
{/* Container */}
        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
            ...
            {/* Grid Item */}
            <div
            style={{ backgroundImage: `url(${ecommerce})` , backgroundSize: 'contain' }}
          ...
          >
            ...
            <div className='opacity-0 group-hover:opacity-100'>
              ...
              <div className='pt-8 text-center'>
                <a href='https://emerald-tours.netlify.app/' target="_blank"rel='noreferrer'>
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Demo
                  </button>
                </a>
          ...
          >
            ...
            <div className='opacity-0 group-hover:opacity-100'>
              ...
              <div className='pt-8 text-center'>
                <a href='https://country-data-lemon.vercel.app/' target="_blank"rel='noreferrer'>
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Demo
                  </button>
                </a>
          ...
          <div
            style={{ backgroundImage: `url(${car})`, backgroundSize: 'contain'  }}
            className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div'
          >
            {/* Hover Effects */}
            <div className='opacity-0 group-hover:opacity-100'>
              ...
              <div className='pt-8 text-center'>
                <a href='http://moving-car-eta.vercel.app/' target="_blank"rel='noreferrer'>
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Demo
                  </button>
                </a>
